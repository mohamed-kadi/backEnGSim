...
The **Report History** panel lists saved learner notes by scenario, completion state, and last update time. It also provides quick actions to reopen a scenario, export its report, or mark it complete.
...
The dashboard is organized as a workspace with sidebar views for Scenarios, Runbook, System, Reports, and Progress, plus a right-side inspector for the active scenario and quick actions.
